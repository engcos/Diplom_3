...
class MainPageLocators:
    ...
    PA_BUTTON = By.XPATH, '//p[contains(text(),"Личный Кабинет")]'
    ...
    INGREDIENTS_BUTTON = By.XPATH, '//span[contains(text(),"Начинки")]'
    INGREDIENT_COUNTER = (By.XPATH, '//*[@href="/ingredient/61c0c5a71d1f82001bdaaa6c"]//p[contains(@class, '
                                    '"counter__num")]')
